#' Detect MMEJ sequence from indel results
#'
#' @param x Number of rows
#' @param data data.frame of Alleles frequency table
#' @param pb ProgressBar object, setting by 'utils::txtProgressBar'
#'
#' @export
...
#' Quant MMEJ sequence and length
#'
#' @param path path to the sample directory which generated by CRISPResso2
#' @param nCores cores used to process data
#' @param proportion how to calculate the proportion of reads, select from c("mmej", "indel")
#' @export
